...
const { sendMessage, sendPhoto, deleteUsMessage, editUsMessage, pinUsMessage, unpinUsMessage, sendfile, sendReaction } = require('./telegramService');
const fs = require('fs');
    ...
    for (const item of items) {
        ...
        try {
            ...
            if (item.type === 'edit') {
                ...
                await deleteUsMessage(payload.messageId);
